...
**Source:** https://support.optisigns.com/hc/en-us/articles/4414355658899-How-to-Use-Microsoft-PowerPoint-with-OptiSigns
...
**NOTE**  
---  
The first time logging on, your account will require Administrator access.

  * If you are using a school/work Microsoft account, your IT admin may need to approve the permission the first time. 
  * If you see a message like “Need admin approval” or you cannot accept the permission screen, please forward that screen to your IT admin and ask them to approve the OptiSigns access request for your tenant. 

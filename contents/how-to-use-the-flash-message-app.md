...
**NOTE**  
---  
For Start & End Times with Recurring Settings, the duration between start and end time must be less than 24 hours.  
  
It can be longer for one-time only messages.  

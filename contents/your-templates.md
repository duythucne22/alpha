...
**NOTE**  
---  
The Custom Template may appear as a black box when it is first added to the design. However, it**** will still function normally. Saving the design and relaunching it should make it appear.   
...
**NOTE**  
---  
The Custom Component may appear as a black box when it is first added to the design. However, it**** will still function normally. Saving the design and relaunching it should make it appear.  
